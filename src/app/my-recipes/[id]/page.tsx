...
export default function RecipeDetailPage() {
    ...
    const renderNutritionalInfo = (ni: NutritionalInfo, title: string, icon: React.ReactNode) => (
        <div>
            <h2 className="text-2xl font-semibold mb-3 text-green-500 flex items-center gap-2">
                {icon} {title}
            </h2>
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 md:gap-6 py-4">
                            {recipe.prepTime && (
                                <div className="flex flex-col items-center p-3 bg-muted/30 rounded-lg">
                                    <Timer className="h-7 w-7 text-blue-500 mb-1.5" />
                            ...
                            {recipe.cookTime && (
                                <div className="flex flex-col items-center p-3 bg-muted/30 rounded-lg">
                                    <Flame className="h-7 w-7 text-red-500 mb-1.5" />
                            ...
                            {recipe.servings && (
                                <div className="flex flex-col items-center p-3 bg-muted/30 rounded-lg">
                                    <Users className="h-7 w-7 text-yellow-500 mb-1.5" />
